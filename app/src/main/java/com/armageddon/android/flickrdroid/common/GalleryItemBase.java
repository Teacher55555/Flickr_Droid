...
/**
 * Sends data from thumbs view (SearchActivity.class or MapActivity.class) to full-size view (PhotoFullActivity.class)
 * and back.
...
public final class GalleryItemBase {
   private static GalleryItemBase mInstance;
   private RequestResponse<GalleryItem> sResponse;

   private GalleryItemBase () {}

   public static GalleryItemBase getInstance() {
      if (mInstance == null) {
          mInstance = new GalleryItemBase();
      }
      return mInstance;
   }

   public RequestResponse<GalleryItem> getResponse(Context context) {
//      if (sResponse == null) {
//         try {
...
//      }
   ...
   public void setResponse(Context context, RequestResponse<GalleryItem> response) {
      sResponse = response;
//      try {
